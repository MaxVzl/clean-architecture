...
export const postsRouter = (diContainer: DIContainer) => {
  ...
  app.openapi(
    getPostsRoute,
    getPostsController(diContainer.get('GetPostsUseCase')),
  );
  app.openapi(
    getPostRoute,
    getPostController(diContainer.get('GetPostUseCase')),
  );
  app.openapi(
    createPostRoute,
    createPostController(diContainer.get('CreatePostUseCase')),
  );
  app.openapi(
    updatePostRoute,
    updatePostController(diContainer.get('UpdatePostUseCase')),
  );
  app.openapi(
    deletePostRoute,
    deletePostController(diContainer.get('DeletePostUseCase')),
  );
