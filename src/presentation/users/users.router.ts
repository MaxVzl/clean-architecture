...
export const usersRouter = (diContainer: DIContainer) => {
  ...
  app.openapi(
    getUsersRoute,
    getUsersController(diContainer.get('GetUsersUseCase')),
  );
  app.openapi(
    getUserRoute,
    getUserController(diContainer.get('GetUserUseCase')),
  );
  app.openapi(
    createUserRoute,
    createUserController(diContainer.get('CreateUserUseCase')),
  );
  app.openapi(
    deleteUserRoute,
    deleteUserController(diContainer.get('DeleteUserUseCase')),
  );
  app.openapi(
    updateUserRoute,
    updateUserController(diContainer.get('UpdateUserUseCase')),
  );
  app.openapi(
    getPostsByUserRoute,
    getPostsByUserController(diContainer.get('GetPostsByUserUseCase')),
  );
